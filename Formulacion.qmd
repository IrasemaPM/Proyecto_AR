...
$S_{t}$: Fracción de susceptibles en el tiempo$t$. $V_{+t}$: Fracción de vacunados inmunes en el tiempo$t$. $V_{-t}$: Fracción de vacunados no inmunes en el tiempo$t$. $I_{t}$: Fracción de infectados en el tiempo$t$. $R_{t}$: Fracción de recuperados en el tiempo$t$.
